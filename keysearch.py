...
if __name__ == '__main__':
    ...
    search_txt = input("Please enter text you want to to search for: ")
    results = googlescrape.scrape(search_txt, num_results_per_page=50, num_pages=3, offset=0)
    for page in results:
